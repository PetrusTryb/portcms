...
export default function RecentPages(props: RecentPagesProps){
    return <section>
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 overflow-y-visible">
            <div className="bg-white dark:bg-gray-800 sm:rounded-lg shadow-[0px_4px_5px_0px_rgba(0,0,0,0.14)]">
                ...
                <div className="px-4 py-4">
                    <div className="grid grid-cols-1 gap-6 overflow-y-visible">
                        <ul>
                        {props.pages?.length?props.pages.map(page => <div key={page._id} className="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
